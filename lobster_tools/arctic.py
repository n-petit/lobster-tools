...
# %% auto 0
__all__ = ['cfg', 'CONTEXT_SETTINGS', 'O', 'click_db_path', 'click_library', 'formatter_full', 'logger', 'handler', 'N',
           'Options', 'apply_options', 'arctic', 'initdb', 'use_both', 'dropdb', 'cool', 'nic', 'read',
           'get_arctic_library', 'ArcticLibraryInfo', 'get_library_info', 'Notify', 'ClickCtxObj', 'ClickCtx', 'echo',
           'new_echo', 'warn', 'init_autocomplete', 'create', 'ls', 'libraries', 'symbols', 'versions',
           'parse_comma_separated', 'dates', 'rm', 'library', 'arctic_list_symbols', 'arctic_create_new_library',
...
# eh bad idea
# def style(f, color=Literal["green", "red"]):
#     def wrapper(message, **kwargs):
#         styled_message = click.style(message, fg=color)  # Add your styles here
#         f(styled_message, **kwargs)
#     return wrapper
...
def echo(ctx: ClickCtx) -> None:
    ...
    # click.echo("blah", fg="green")
    logger.info(pformat(ctx.obj))


# monkey patch click.echo to accept a color
...
def libraries(ctx: ClickCtx):
    arctic = ctx.obj["arctic"]
    logger.info(arctic.list_libraries())
