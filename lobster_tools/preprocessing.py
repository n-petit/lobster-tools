...
# %% auto 0
__all__ = ['Event', 'EventGroup', 'Direction', 'Data', 'clip_df_times', 'Lobster', 'MPLobster', 'load_lobster', 'load_lobsters',
           'FolderInfo', 'infer_ticker_dict']
...
class FolderInfo:
    ...
    start_date: str
    end_date: str
    date_range: tuple = field(init=False)
