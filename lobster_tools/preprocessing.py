__all__ = ['Event', 'EventGroup', 'Direction', 'Data', 'clip_times', 'Lobster', 'MPLobster', 'FolderInfo', 'infer_ticker_date_ranges']
...
def infer_ticker_date_ranges(
    dir: str = "/nfs/data/lobster_data/lobster_raw/2021/", /
) -> list[FolderInfo]:
