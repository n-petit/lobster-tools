...
# %% auto 0
__all__ = ['another_example_change_to_test_precommit_hook', 'testa', 'cli_example', 'Event', 'EventGroup', 'Direction', 'Data',
           'Lobster', 'load_lobster', 'load_lobsters']

# %% ../notebooks/00_preprocessing.ipynb 4
def another_example_change_to_test_precommit_hook():
...
# %% ../notebooks/00_preprocessing.ipynb 14
@enum.unique
