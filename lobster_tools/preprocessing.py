...
# %% auto 0
__all__ = ['Event', 'EventGroup', 'Direction', 'Data', 'Lobster', 'load_lobster', 'load_lobsters']

# %% ../notebooks/00_preprocessing.ipynb 4
import enum
import glob
from typing import Optional, Literal, TypeVar, get_args
...
class Lobster:
    ...
    # TODO: type hinting for Lobster a forward reference?
    # c.f https://stackoverflow.com/questions/63503512/python-type-hinting-own-class-in-method
    def clip_trading_hours(self) -> 'Lobster':
    ...
    def aggregate_duplicates(self) -> 'Lobster':
    ...
    def add_ticker_column(self, to: Literal["both", "messages", "book"] = "messages") -> 'Lobster':
