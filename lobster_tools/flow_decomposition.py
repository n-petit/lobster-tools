...
__all__ = ['str_to_nanoseconds', 'col_to_dtype', 'features', 'all_index', 'empty_series', 'get_times', 'str_to_time',
           ...
           'groupby_index_to_series', 'compute_features', 'append_features', 'count_non_null', 'old_marginalise',
           'add_arb_tag', 'drop_features', 'split_isolated_non_isolated', 'old_ofi', 'ofis', 'not_ofi',
           'old_compute_ofi', 'resample_mid', 'restrict_common_index', 'markout_returns', 'clip_for_markout']
...
def old_marginalise(df: pd.DataFrame, 
                over: t.Literal["same_sign/opposite_sign", "before/after"], # which feature to marginalise over 
...
# %% ../notebooks/03_flow_decomposition.ipynb 18
...
def old_compute_ofi(
    df: pd.DataFrame, resample_freq: str = "5T", arb_filter: t.Optional[str] = None
) -> pd.DataFrame:
...
# %% ../notebooks/03_flow_decomposition.ipynb 19
...
# %% ../notebooks/03_flow_decomposition.ipynb 20
...
# %% ../notebooks/03_flow_decomposition.ipynb 21
def markout_returns(
...
# %% ../notebooks/03_flow_decomposition.ipynb 23
# TODO fix this
# def compute_returns():
...
# %% ../notebooks/03_flow_decomposition.ipynb 25
