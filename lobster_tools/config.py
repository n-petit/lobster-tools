...
# %% auto 0
__all__ = ['SimpleHyperparametersConfig', 'FullHyperparametersConfig', 'XLEUniverseConfig', 'defaults', 'ArcticDBConfig',
           'DataConfig', 'SampleDataConfig', 'HyperparametersConfig', 'UniverseConfig', 'SimpleUniverseConfig',
           'CustomHydraConfig', 'MainConfig', 'register_configs']
...
FullHyperparametersConfig = HyperparametersConfig(tolerances=['150us', '250us', '500us'], resample_freq="5min", markouts=["30S", "1min", "2min", "5min"])
...
defaults = [{"hyperparameters": "simple"}, {"universe":"simple"}, "_self_"]
@dataclass
class MainConfig:
...
def register_configs() -> None:
    ...
    # note that you can pass an instance or a class as the node as below
