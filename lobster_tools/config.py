...
# %% auto 0
__all__ = ['ArcticDBConfig', 'DataConfig', 'SampleDataConfig', 'HyperparametersConfig', 'UniverseConfig', 'CustomHydraConfig',
           'MainConfig', 'register_configs']
...
class MainConfig:
    ...
    universe_: UniverseConfig = field(default_factory= UniverseConfig)
